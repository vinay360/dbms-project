...
router.get(
  '/:hotelName/:hotelBranch/reservationRequests',
  loadReservationRequestsPage
);
function loadReservationRequestsPageCB(req, res, result) {
  let reservations = JSON.parse(result);
  console.log(reservations);
  res.render('pages/reservation_requests', {
...
function loadReservationRequestsPage(req, res) {
  let params = [req.params.hotelName, req.params.hotelBranch];
  console.log(params);
  query.resQueries.resSelect.retrieveHotelResList(
    req,
    res,
    params,
    loadReservationRequestsPageCB
  );
}
/*-------------------------------------------------------*/
...
/*-----------Accept Reservation-------------------------*/
router.post(
  '/:hotelName/:hotelBranch/reservationRequests/:resID/accept',
  acceptReservation
);
...
function acceptReservation(req, res) {
  query.resQueries.resUpdate.ApproveReservation(
    req,
    res,
    req.params.resID,
    acceptReservationCB
...
/*-----------Deny Reservation---------------------------*/
router.post(
  '/:hotelName/:hotelBranch/reservationRequests/:resID/deny',
  denyReservation
);
...
function denyReservation(req, res) {
  query.resQueries.resUpdate.DenyReservation(
    req,
    res,
    req.params.resID,
    denyReservationCB
